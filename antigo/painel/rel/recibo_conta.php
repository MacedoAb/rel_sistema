...
<div class="receipt-main">
							...
							<img style="margin-left:10px" class="imagem" src="<?php echo $url_sistema ?>img/logo.jpg" width="200px" height="60px">
  ...
  <div class="receipt-section pull-left">
    ...
    <span style="margin-right:7px"class="text-large receipt-label direita">VALOR R$ <?php echo $valorF ?></span>
  ...
  <div class="receipt-section">
    <span>
      <p style="margin-left:50px"><big> Recebi(emos) de <b><?php echo $nome_pessoa ?></b> o valor de R$ <b><?php echo $valorF ?> 
    </b> no dia <b><?php echo $data_pgtoF ?></b> correspondente a(ao) <?php echo $descricao ?>.</p> 
  ...
  <?php if($assinatura_recibo != 'Sim'){
  	...
  	?>
  	<img src="<?php echo $url_sistema ?>/img/assinatura2.jpg" width="" height=""><br>
  <?php } ?>
