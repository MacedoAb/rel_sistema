						...
						<ul class="sidebar-menu">
							...
							<li class="treeview <?php echo @$menu_pessoas ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo @$clientes ?>"><a href="clientes"><i class="fa fa-folder-open-o"></i> Pacientes</a></li>
							...
							<li class="treeview <?php echo @$menu_financeiro ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo @$rel_financeiro ?>"><a href="" data-toggle="modal" data-target="#modalRelFin"><i class="fa fa-file-text"></i> Relatório Financeiro</a></li>


									<li class="<?php echo @$rel_sintetico_despesas ?>"><a href="" data-toggle="modal" data-target="#modalRelSinDesp"><i class="fa fa-file-text"></i> Rel Sintético Despesas</a></li>

										<li class="<?php echo @$rel_sintetico_receber ?>"><a href="" data-toggle="modal" data-target="#modalRelSinRec"><i class="fa fa-file-text"></i> Rel Sintético Receber</a></li>


									<li class="<?php echo @$rel_balanco ?>"><a href="rel/balanco_anual_class.php" target="_blank"><i class="fa fa-file-text"></i> Rel Balanço Anual</a></li>
